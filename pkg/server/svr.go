...
func (lsServer *LsServer) Listen(didListen func(listenAddr *net.TCPAddr)) error {
	return cipher.ListenEncryptedTCP(lsServer.ListenAddr, lsServer.Cipher, lsServer.handleConn, didListen)
}

// 解 SOCKS5 协议
// https://www.ietf.org/rfc/rfc1928.txt
func (lsServer *LsServer) handleConn(localConn *cipher.SecureTCPConn) {
